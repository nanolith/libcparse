 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_greater_than_equal)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_increment)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_decrement)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_not)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_preprocessor_id_ifdef)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_preprocessor_id_ifndef)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_preprocessor_id_elif)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_preprocessor_id_else)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_preprocessor_id_include)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_preprocessor_id_define)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_preprocessor_id_undef)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_preprocessor_id_error)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_preprocessor_id_pragma)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_preprocessor_hash)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword__Alignas)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword__Atomic)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword__Bool)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword__Complex)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword__Generic)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword__Imaginary)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword__Noreturn)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword__Static_assert)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword__Thread_local)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_auto)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_break)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_case)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_char)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_const)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_default)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_do)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_double)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_else)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_enum)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_extern)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_float)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_for)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_goto)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_if)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_inline)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_int)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_long)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_register)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_restrict)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_return)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_short)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_signed)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_sizeof)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_static)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_struct)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_switch)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_typedef)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_union)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_unsigned)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_void)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_volatile)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_token_keyword_while)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_expression_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_primary_expression_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_expression_part_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_array_subscript_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_array_subscript_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_function_call_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_function_call_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_dot_member_deref_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_dot_member_deref_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_arrow_member_deref_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_arrow_member_deref_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_postfix_increment_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_postfix_decrement_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_postfix_decrement_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_compound_literal_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_compound_literal_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_prefix_increment_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_prefix_increment_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_prefix_decrement_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_prefix_decrement_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_unary_operation_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_unary_operation_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_sizeof_exp_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_sizeof_type_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_sizeof_type_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_alignof_type_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_alignof_type_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_cast_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_cast_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_multiply_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_multiply_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_divide_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_divide_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_modulo_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_modulo_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_add_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_add_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_sub_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_sub_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_bitshift_left_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_bitshift_left_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_bitshift_right_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_less_than_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_less_than_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_greater_than_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_greater_than_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_less_than_equal_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_greater_than_equal_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_greater_than_equal_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_equal_to_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_equal_to_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_not_equal_to_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_bitwise_and_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_bitwise_and_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_bitwise_xor_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_bitwise_xor_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_bitwise_or_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_logical_and_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_logical_or_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_conditional_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_assignment_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_assignment_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_comma_begin)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
 ...
 *      - a non-zero error code on failure.
 */
int CPARSE_SYM(event_init_for_exp_comma_end)(
    CPARSE_SYM(event)* ev, const CPARSE_SYM(cursor)* cursor);
...
#define __INTERNAL_CPARSE_IMPORT_event_sym(sym) \
    ...
    static inline int sym ## event_init_for_token_decrement( \
        CPARSE_SYM(event)* x, const CPARSE_SYM(cursor)* y) { \
            return CPARSE_SYM(event_init_for_token_decrement)(x,y); } \
    static inline int sym ## event_init_for_token_not( \
        CPARSE_SYM(event)* x, const CPARSE_SYM(cursor)* y) { \
            return CPARSE_SYM(event_init_for_token_not)(x,y); } \
    static inline int sym ## event_init_for_token_ellipsis( \
        CPARSE_SYM(event)* x, const CPARSE_SYM(cursor)* y) { \
    ...
    static inline int sym ## event_init_for_token_preprocessor_id_ifdef( \
        CPARSE_SYM(event)* x, const CPARSE_SYM(cursor)* y) { \
            return \
                CPARSE_SYM(event_init_for_token_preprocessor_id_ifdef)(x,y); } \
    static inline int sym ## event_init_for_token_preprocessor_id_ifndef( \
        CPARSE_SYM(event)* x, const CPARSE_SYM(cursor)* y) { \
            return \
    ...
    static inline int sym ## event_init_for_token_preprocessor_id_else( \
        CPARSE_SYM(event)* x, const CPARSE_SYM(cursor)* y) { \
            return \
    ...
    static inline int sym ## event_init_for_token_preprocessor_id_include( \
        CPARSE_SYM(event)* x, const CPARSE_SYM(cursor)* y) { \
            return \
                CPARSE_SYM(event_init_for_token_preprocessor_id_include)( \
                    x,y); } \
    static inline int sym ## event_init_for_token_preprocessor_id_define( \
        CPARSE_SYM(event)* x, const CPARSE_SYM(cursor)* y) { \
            return \
