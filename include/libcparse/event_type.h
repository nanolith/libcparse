...
enum CPARSE_SYM(event_type)
{
    ...
    CPARSE_EVENT_TYPE_PREPROCESSOR_DEFINE =         0x0041,
    CPARSE_EVENT_TYPE_PREPROCESSOR_UNDEF =          0x0042,
    CPARSE_EVENT_TYPE_PREPROCESSOR_LINE =           0x0043,
    CPARSE_EVENT_TYPE_PREPROCESSOR_ERROR =          0x0044,
    CPARSE_EVENT_TYPE_PREPROCESSOR_PRAGMA =         0x0045,
    CPARSE_EVENT_TYPE_PREPROCESSOR_ESCAPE_NEWLINE = 0x0046,
    CPARSE_EVENT_TYPE_PREPROCESSOR_IF =             0x0047,
    CPARSE_EVENT_TYPE_PREPROCESSOR_IFDEF =          0x0048,
    CPARSE_EVENT_TYPE_PREPROCESSOR_IFNDEF =         0x0049,
    CPARSE_EVENT_TYPE_PREPROCESSOR_ELIF =           0x004A,
    CPARSE_EVENT_TYPE_PREPROCESSOR_ELSE =           0x004B,
    CPARSE_EVENT_TYPE_PREPROCESSOR_ENDIF =          0x004C,
