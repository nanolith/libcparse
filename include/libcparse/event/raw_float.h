 ...
 */
int FN_DECL_MUST_CHECK CPARSE_SYM(event_raw_float_token_dispose)(
 ...
 *      - a non-zero error code on failure.
 */
int FN_DECL_MUST_CHECK CPARSE_SYM(event_raw_float_token_sign_set)(
