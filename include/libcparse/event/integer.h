...
#define __INTERNAL_CPARSE_IMPORT_event_integer_sym(sym) \
    ...
    static inline int FN_DECL_MUST_CHECK \
    sym ## event_integer_token_convert_to_unsigned_long( \
