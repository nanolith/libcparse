...
enum CPARSE_SYM(status_code)
{
    ...
    ERROR_LIBCPARSE_PP_SCANNER_HEX_P_EXPECTING_DIGIT =                  1022,
    ERROR_LIBCPARSE_BAD_INTEGER_CONVERSION =                            1023,
    ERROR_LIBCPARSE_ENTRY_NOT_FOUND =                                   1024,
    ERROR_LIBCPARSE_FILE_CLOSE_ERROR =                                  1025,
    ERROR_LIBCPARSE_FILE_OPEN_ERROR =                                   1026,
    ERROR_LIBCPARSE_FILE_SEEK =                                         1027,
