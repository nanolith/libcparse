 ...
 * An unterminated block comment results in an error.
 */
TEST(unterminated_block_comment_2)
{
    comment_scanner* scanner;
    input_stream* stream;
    event_handler eh;
...
/**
 * Test that a quoted comment is just a string.
 */
TEST(string_escape1)
{
    comment_scanner* scanner;
...
/**
 * Test that a quoted comment with an escaped quote is just a string.
 */
TEST(string_escape2)
{
    comment_scanner* scanner;
...
/**
 * Test that a quoted character sequence is just a character sequence.
 */
TEST(char_escape1)
{
    comment_scanner* scanner;
...
/**
 * Test that a quoted comment with an escaped quote is just a char sequence.
 */
TEST(char_escape2)
{
    comment_scanner* scanner;
