...
/**
 * Test that we properly handle a newline string newline.
 */
TEST(newline_string_newline)
{
    newline_preserving_whitespace_filter* filter;
    input_stream* stream;
    event_handler eh;
    ...
    /* postcondition: there are two newlines. */
    TEST_EXPECT(2 == t1.newline);
...
/**
 * Entering the character state after whitespace works as expected.
 */
TEST(whitespace_char_state)
{
    newline_preserving_whitespace_filter* filter;
    input_stream* stream;
    event_handler eh;
...
/**
 * Test newline to char literal to newline.
 */
TEST(newline_char_newline)
{
    newline_preserving_whitespace_filter* filter;
    input_stream* stream;
    event_handler eh;
