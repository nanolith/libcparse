...
EVENT_INIT_TYPE_TEST(
    event_init_for_token_keyword_break, CPARSE_EVENT_TYPE_TOKEN_KEYWORD_BREAK);
EVENT_INIT_TYPE_TEST(
...
EVENT_INIT_TYPE_TEST(
    event_init_for_token_keyword_continue,
...
EVENT_INIT_TYPE_TEST(
    event_init_for_token_keyword_double,
...
EVENT_INIT_TYPE_TEST(
    event_init_for_token_keyword_long, CPARSE_EVENT_TYPE_TOKEN_KEYWORD_LONG);
EVENT_INIT_TYPE_TEST(
    event_init_for_token_keyword_register,
...
EVENT_INIT_TYPE_TEST(
    event_init_for_token_keyword_short, CPARSE_EVENT_TYPE_TOKEN_KEYWORD_SHORT);
EVENT_INIT_TYPE_TEST(
    event_init_for_token_keyword_signed,
...
EVENT_INIT_TYPE_TEST(
    event_init_for_token_keyword_typedef,
    CPARSE_EVENT_TYPE_TOKEN_KEYWORD_TYPEDEF);
EVENT_INIT_TYPE_TEST(
    event_init_for_token_keyword_union, CPARSE_EVENT_TYPE_TOKEN_KEYWORD_UNION);
EVENT_INIT_TYPE_TEST(
