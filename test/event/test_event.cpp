...
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_sizeof_exp_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_SIZEOF_EXP_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_sizeof_exp_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_SIZEOF_EXP_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_sizeof_type_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_SIZEOF_TYPE_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_sizeof_type_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_SIZEOF_TYPE_END);
EVENT_INIT_CAT_TYPE_TEST(
...
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_cast_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_CAST_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_cast_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_CAST_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_multiply_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_MULTIPLY_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_multiply_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_MULTIPLY_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_divide_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_DIVIDE_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_divide_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_DIVIDE_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_modulo_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_MODULO_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_modulo_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_MODULO_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_add_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_ADD_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_add_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_ADD_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_sub_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_SUB_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_sub_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_SUB_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_bitshift_left_begin, CPARSE_EVENT_CATEGORY_BASE,
...
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_bitshift_right_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_BITSHIFT_RIGHT_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_less_than_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_LESS_THAN_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
...
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_greater_than_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_GREATER_THAN_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_less_than_equal_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_LESS_THAN_EQUAL_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_less_than_equal_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_LESS_THAN_EQUAL_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_greater_than_equal_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_GREATER_THAN_EQUAL_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_greater_than_equal_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_GREATER_THAN_EQUAL_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_equal_to_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_EQUAL_TO_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_equal_to_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_EQUAL_TO_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_not_equal_to_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_NOT_EQUAL_TO_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_not_equal_to_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_NOT_EQUAL_TO_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_bitwise_and_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_BITWISE_AND_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_bitwise_and_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_BITWISE_AND_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_bitwise_xor_begin, CPARSE_EVENT_CATEGORY_BASE,
...
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_bitwise_or_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_BITWISE_OR_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_logical_and_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_LOGICAL_AND_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_logical_and_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_LOGICAL_AND_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_logical_or_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_LOGICAL_OR_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_logical_or_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_LOGICAL_OR_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_conditional_begin, CPARSE_EVENT_CATEGORY_BASE,
...
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_assignment_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_ASSIGNMENT_END);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_comma_begin, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_COMMA_BEGIN);
EVENT_INIT_CAT_TYPE_TEST(
    event_init_for_exp_comma_end, CPARSE_EVENT_CATEGORY_BASE,
    CPARSE_EVENT_TYPE_EXP_COMMA_END);
