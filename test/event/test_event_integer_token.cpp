...
TEST(signed_integer_coerce_to_unsigned_long_long)
{
    ...
    /* the unsigned long long value matches. */
    TEST_EXPECT(TEST_VAL == val);
...
/**
 * Test that we can coerce an integer to an int16.
 */
TEST(signed_integer_coerce_to_int16)
{
    cursor pos;
    event_integer_token ev;
    const int TEST_VAL = 12;
...
/**
 * Test that we can coerce an integer to a uint16.
 */
TEST(signed_integer_coerce_to_uint16)
{
    cursor pos;
    event_integer_token ev;
    const int TEST_VAL = 12;
    ...
    /* we can convert this value to a uint16_t. */
    val = event_integer_token_coerce_uint16(&ev);

    /* the uint16_t value matches. */
    TEST_EXPECT(TEST_VAL == val);
...
/**
 * Test that we can coerce an unsigned integer to a uint16.
 */
TEST(unsigned_integer_coerce_to_uint16)
{
    cursor pos;
    event_integer_token ev;
    const unsigned int TEST_VAL = 12;
...
/**
 * Test that we can coerce an integer to an int32.
 */
TEST(signed_integer_coerce_to_int32)
{
    cursor pos;
    event_integer_token ev;
    const int TEST_VAL = 12;
    ...
    /* we can convert this value to an int32_t. */
    val = event_integer_token_coerce_int32(&ev);

    /* the int32_t value matches. */
    TEST_EXPECT(TEST_VAL == val);
...
/**
 * Test that we can coerce an unsigned integer to an int32.
 */
TEST(unsigned_integer_coerce_to_int32)
{
    cursor pos;
    event_integer_token ev;
    const unsigned int TEST_VAL = 12;
...
/**
 * Test that we can coerce an integer to a uint32.
 */
TEST(signed_integer_coerce_to_uint32)
{
    cursor pos;
    event_integer_token ev;
    const int TEST_VAL = 12;
    ...
    /* we can convert this value to a uint32_t. */
    val = event_integer_token_coerce_uint32(&ev);

    /* the uint32_t value matches. */
    TEST_EXPECT(TEST_VAL == val);
...
/**
 * Test that we can coerce an unsigned integer to a uint32.
 */
TEST(unsigned_integer_coerce_to_uint32)
{
    cursor pos;
    event_integer_token ev;
    const unsigned int TEST_VAL = 12;
...
/**
 * Test that we can coerce an unsigned integer to an int64.
 */
TEST(unsigned_integer_coerce_to_int64)
{
    cursor pos;
    event_integer_token ev;
    const unsigned int TEST_VAL = 12;
...
/**
 * Test that we can coerce an integer to a uint64.
 */
TEST(signed_integer_coerce_to_uint64)
{
    cursor pos;
    event_integer_token ev;
    const int TEST_VAL = 12;
    ...
    /* we can convert this value to a uint64_t. */
    val = event_integer_token_coerce_uint64(&ev);

    /* the uint64_t value matches. */
    TEST_EXPECT(TEST_VAL == val);
...
/**
 * Test that we can coerce an unsigned integer to a uint64.
 */
TEST(unsigned_integer_coerce_to_uint64)
{
    cursor pos;
    event_integer_token ev;
    const unsigned int TEST_VAL = 12;
