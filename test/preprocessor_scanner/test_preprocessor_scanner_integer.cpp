...
INT_TEST_EXPECT_SUCCESS(xL,         "0xaL");
INT_TEST_EXPECT_SUCCESS(ul,         "0xaul");
INT_TEST_EXPECT_SUCCESS(uL,         "0xauL");
INT_TEST_EXPECT_SUCCESS(Ul,         "0xaUl");
INT_TEST_EXPECT_SUCCESS(UL,         "0xaUL");
INT_TEST_EXPECT_SUCCESS(ull,        "0xaull");
INT_TEST_EXPECT_SUCCESS(ulL,        "0xaulL");
INT_TEST_EXPECT_SUCCESS(uLl,        "0xauLl");
INT_TEST_EXPECT_SUCCESS(uLL,        "0xauLL");
INT_TEST_EXPECT_SUCCESS(Ull,        "0xaUll");
...
INT_TEST_EXPECT_SUCCESS(ULl,        "0xaULl");
INT_TEST_EXPECT_SUCCESS(ULL,        "0xaULL");
INT_TEST_EXPECT_SUCCESS(ll,         "0xall");
INT_TEST_EXPECT_SUCCESS(lL,         "0xalL");
INT_TEST_EXPECT_SUCCESS(Ll,         "0xaLl");
INT_TEST_EXPECT_SUCCESS(LL,         "0xaLL");
INT_TEST_EXPECT_SUCCESS(lu,         "0xalu");
INT_TEST_EXPECT_SUCCESS(lU,         "0xalU");
INT_TEST_EXPECT_SUCCESS(Lu,         "0xaLu");
INT_TEST_EXPECT_SUCCESS(LU,         "0xaLU");
INT_TEST_EXPECT_SUCCESS(llu,        "0xallu");
INT_TEST_EXPECT_SUCCESS(llU,        "0xallU");
INT_TEST_EXPECT_SUCCESS(lLu,        "0xalLu");
INT_TEST_EXPECT_SUCCESS(lLU,        "0xalLU");
INT_TEST_EXPECT_SUCCESS(Llu,        "0xaLlu");
