...
FLOAT_TEST_EXPECT_SUCCESS(float_1_dot_4e7_suffix_F,     "1.4e7F");
FLOAT_TEST_EXPECT_SUCCESS(float_1_dot_4e7_suffix_l,     "1.4e7l");
FLOAT_TEST_EXPECT_SUCCESS(float_1_dot_4e7_suffix_L,     "1.4e7L");
...
FLOAT_TEST_EXPECT_SUCCESS(hex_float_zero_dot_p0_suf_F,  "0x0.p0F");
FLOAT_TEST_EXPECT_SUCCESS(hex_float_zero_dot_p0_suf_l,  "0x0.p0l");
FLOAT_TEST_EXPECT_SUCCESS(hex_float_zero_dot_p0_suf_L,  "0x0.p0L");
FLOAT_TEST_EXPECT_SUCCESS(hex_float_1_dot_1_p0_suf_f,   "0x1.1p0f");
FLOAT_TEST_EXPECT_SUCCESS(hex_float_1_dot_1_p0_suf_F,   "0x1.1p0F");
FLOAT_TEST_EXPECT_SUCCESS(hex_float_1_dot_1_p0_suf_l,   "0x1.1p0l");
FLOAT_TEST_EXPECT_SUCCESS(hex_float_1_dot_1_p0_suf_L,   "0x1.1p0L");
FLOAT_TEST_EXPECT_SUCCESS(hex_f_1_dot_1_p_neg_5_suf_f,  "0x1.1p-5f");
FLOAT_TEST_EXPECT_SUCCESS(hex_f_1_dot_1_p_neg_5_suf_F,  "0x1.1p-5F");
FLOAT_TEST_EXPECT_SUCCESS(hex_f_1_dot_1_p_neg_5_suf_l,  "0x1.1p-5l");
