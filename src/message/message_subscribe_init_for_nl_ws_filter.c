/**
 * \file src/message/message_subscribe_init_for_nl_ws_filter.c
 *
 * \brief \ref message_subscribe type init method for newline preserving
 * whitespace filter subscriptions.
 *
