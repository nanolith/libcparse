...
#define __INTERNAL_CPARSE_IMPORT_line_wrap_filter_internal_sym(sym) \
    CPARSE_BEGIN_EXPORT \
...
#define CPARSE_IMPORT_line_wrap_filter_internal_as(sym) \
    __INTERNAL_CPARSE_IMPORT_line_wrap_filter_internal_sym(sym ## _)
#define CPARSE_IMPORT_line_wrap_filter_internal \
    __INTERNAL_CPARSE_IMPORT_line_wrap_filter_internal_sym()
