...
enum CPARSE_SYM(preprocessor_scanner_state)
{
    ...
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR =                        47,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_SLASH =                  48,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_OCTAL_1 =                49,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_OCTAL_2 =                50,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_HEX =                    51,
    ...
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_LITTLE_U3 =              56,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_BIG_U =                  57,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_BIG_U1 =                 58,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_BIG_U2 =                 59,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_BIG_U3 =                 60,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_BIG_U4 =                 61,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_BIG_U5 =                 62,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_BIG_U6 =                 63,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_CHAR_BIG_U7 =                 64,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_DOT =                         65,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_DOT_DOT =                     66,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_COLON =                       67,
};
