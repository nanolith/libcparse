...
enum CPARSE_SYM(preprocessor_scanner_state)
{
    ...
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_HEX_FLOAT =                   74,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_HEX_FLOAT_P_EXPECT_DIGIT =    75,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_HEX_FLOAT_P_S_EXPECT_DIGIT =  76,
    CPARSE_PREPROCESSOR_SCANNER_STATE_IN_HEX_FLOAT_P_WITH_DIGIT =      77,
};
