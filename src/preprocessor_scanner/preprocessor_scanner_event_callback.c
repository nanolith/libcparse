...
static int broadcast_tilde_token(
    preprocessor_scanner* scanner, const event* ev);
static int broadcast_question_token(
    preprocessor_scanner* scanner, const event* ev);
...
static int broadcast_equal_assign_token(
    preprocessor_scanner* scanner, const event* ev);
static int broadcast_plus_equal_token(
    preprocessor_scanner* scanner, const event* ev);
static int broadcast_minus_equal_token(
    preprocessor_scanner* scanner, const event* ev);
static int broadcast_times_equal_token(
    preprocessor_scanner* scanner, const event* ev);
static int broadcast_div_equal_token(
    preprocessor_scanner* scanner, const event* ev);
static int broadcast_mod_equal_token(
    preprocessor_scanner* scanner, const event* ev);
static int broadcast_and_equal_token(
    preprocessor_scanner* scanner, const event* ev);
...
static int broadcast_greater_than_equal_token(
    preprocessor_scanner* scanner, const event* ev);
static int broadcast_increment_token(
    preprocessor_scanner* scanner, const event* ev);
static int broadcast_decrement_token(
    preprocessor_scanner* scanner, const event* ev);
    ...
    switch (scanner->state)
    {
        ...
        case CPARSE_PREPROCESSOR_SCANNER_STATE_IN_DASH:
            switch (ch)
            {
                ...
                case '-':
                    return broadcast_decrement_token(scanner, ev);
        ...
        case CPARSE_PREPROCESSOR_SCANNER_STATE_IN_PLUS:
            ...
            {
                case '=':
                    return broadcast_plus_equal_token(scanner, ev);

                case '+':
                    return broadcast_increment_token(scanner, ev);
        ...
        case CPARSE_PREPROCESSOR_SCANNER_STATE_IN_STAR:
            ...
            {
                case '=':
                    return broadcast_times_equal_token(scanner, ev);
        ...
        case CPARSE_PREPROCESSOR_SCANNER_STATE_IN_PERCENT:
            ...
            {
                case '=':
                    return broadcast_mod_equal_token(scanner, ev);
        ...
        case CPARSE_PREPROCESSOR_SCANNER_STATE_IN_AMPERSAND:
            switch (ch)
            {
                ...
                case '=':
                    return broadcast_and_equal_token(scanner, ev);
...
static int start_not(preprocessor_scanner* scanner, const event* ev)
{
    ...
    /* we are now in the not state. */
    scanner->state = CPARSE_PREPROCESSOR_SCANNER_STATE_IN_NOT;
...
static int start_gt(preprocessor_scanner* scanner, const event* ev)
{
    ...
    /* we are now in the gt state. */
    scanner->state = CPARSE_PREPROCESSOR_SCANNER_STATE_IN_GT;
...
/**
 * \brief Broadcast a question token.
 *
 * \param scanner           The scanner for this operation.
 * \param ev                The raw character event for this operation.
 *
    ...
    preprocessor_scanner* scanner, const event* ev)
{
    ...
    /* initialize the token event. */
    retval = event_init_for_token_question(&tev, pos);
    if (STATUS_SUCCESS != retval)
    {
        goto done;
    }
...
/**
 * \brief Broadcast a plus equal token.
 *
 * \param scanner           The scanner for this operation.
 * \param ev                The raw character event for this operation.
 *
    ...
    preprocessor_scanner* scanner, const event* ev)
{
    ...
    /* initialize the token event. */
    retval = event_init_for_token_plus_equal(&tev, pos);
    if (STATUS_SUCCESS != retval)
    {
        goto done;
    }
...
/**
 * \brief Broadcast a minus equal token.
 *
 * \param scanner           The scanner for this operation.
 * \param ev                The raw character event for this operation.
 *
    ...
    preprocessor_scanner* scanner, const event* ev)
{
    ...
    /* initialize the token event. */
    retval = event_init_for_token_minus_equal(&tev, pos);
    if (STATUS_SUCCESS != retval)
    {
        goto done;
    }
...
/**
 * \brief Broadcast a times equal token.
 *
 * \param scanner           The scanner for this operation.
 * \param ev                The raw character event for this operation.
 *
...
/**
 * \brief Broadcast a mod equal token.
 *
 * \param scanner           The scanner for this operation.
 * \param ev                The raw character event for this operation.
 *
    ...
    preprocessor_scanner* scanner, const event* ev)
{
    ...
    /* initialize the token event. */
    retval = event_init_for_token_mod_equal(&tev, pos);
    if (STATUS_SUCCESS != retval)
    {
        goto done;
    }
...
/**
 * \brief Broadcast an and equal token.
 *
 * \param scanner           The scanner for this operation.
 * \param ev                The raw character event for this operation.
 *
    ...
    preprocessor_scanner* scanner, const event* ev)
{
    ...
    /* initialize the token event. */
    retval = event_init_for_token_and_equal(&tev, pos);
    if (STATUS_SUCCESS != retval)
    {
        goto done;
    }
...
/**
 * \brief Broadcast an increment token.
 *
 * \param scanner           The scanner for this operation.
 * \param ev                The raw character event for this operation.
 *
    ...
    preprocessor_scanner* scanner, const event* ev)
{
    ...
    /* initialize the token event. */
    retval = event_init_for_token_increment(&tev, pos);
    if (STATUS_SUCCESS != retval)
    {
        goto done;
    }
...
/**
 * \brief Broadcast a decrement token.
 *
 * \param scanner           The scanner for this operation.
 * \param ev                The raw character event for this operation.
 *
    ...
    preprocessor_scanner* scanner, const event* ev)
{
    ...
    /* initialize the token event. */
    retval = event_init_for_token_decrement(&tev, pos);
    if (STATUS_SUCCESS != retval)
    {
        goto done;
    }
