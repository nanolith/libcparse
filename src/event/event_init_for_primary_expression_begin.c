/**
 * \file src/event/event_init_for_primary_expression_begin.c
 *
 * \brief Initialize an event instance for a primary expression begin event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_PRIMARY_EXPRESSION_BEGIN, cursor);
}
