/**
 * \file src/event/event_init_for_exp_bitshift_right_end.c
 *
 * \brief Initialize an event instance for a bitshift right end event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_EXP_BITSHIFT_RIGHT_END, cursor);
}
