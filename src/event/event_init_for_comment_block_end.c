/**
 * \file src/event/event_init_for_comment_block_end.c
 *
 * \brief Initialize an event instance for the comment block end event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_COMMENT_BLOCK_END, cursor);
}
