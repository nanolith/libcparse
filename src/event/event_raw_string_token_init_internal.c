/**
 * \file src/event/event_raw_string_token_init_internal.c
 *
 * \brief Init method for the \ref event_raw_string_token type.
 *
 ...
 */
int CPARSE_SYM(event_raw_string_token_init_internal)(
