/**
 * \file src/event/event_init_for_token_right_bracket.c
 *
 * \brief Initialize an event instance for the right bracket token event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_TOKEN_RIGHT_BRACKET, cursor);
}
