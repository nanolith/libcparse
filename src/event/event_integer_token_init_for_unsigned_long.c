/**
 * \file src/event/event_integer_token_init_for_unsigned_long.c
 *
 * \brief Initialize an unsigned long \ref event_integer_token instance.
 *
    ...
    unsigned long val)
{
    return
        event_integer_init_for_unsigned_internal(
            ev, CPARSE_INTEGER_TYPE_UNSIGNED_LONG, cursor, val);
}
