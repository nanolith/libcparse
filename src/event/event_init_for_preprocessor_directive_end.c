/**
 * \file src/event/event_init_for_preprocessor_directive_end.c
 *
 * \brief Initialize an event instance for the preprocessor directive end event.
 *
...
{
    return
        event_init(ev, CPARSE_EVENT_TYPE_PP_END, CPARSE_EVENT_CATEGORY_BASE,
        cursor);
}
