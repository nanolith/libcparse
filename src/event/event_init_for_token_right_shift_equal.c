/**
 * \file src/event/event_init_for_token_right_shift_equal.c
 *
 * \brief Initialize an event instance for the right shift equal token event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_TOKEN_RIGHT_SHIFT_EQUAL, cursor);
}
