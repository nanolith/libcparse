/**
 * \file src/event/event_init_for_token_greater_than.c
 *
 * \brief Initialize an event instance for the greater than token event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_TOKEN_GREATER_THAN, cursor);
}
