/**
 * \file src/event/event_init_for_exp_logical_or_end.c
 *
 * \brief Initialize an event instance for a logical or end event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_EXP_LOGICAL_OR_END, cursor);
}
