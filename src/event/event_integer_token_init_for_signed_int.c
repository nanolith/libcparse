/**
 * \file src/event/event_integer_token_init_for_signed_int.c
 *
 * \brief Initialize a signed int \ref event_integer_token instance.
 *
    ...
    int val)
{
    return
        event_integer_init_for_signed_internal(
            ev, CPARSE_INTEGER_TYPE_SIGNED_INT, cursor, val);
}
