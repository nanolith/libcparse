/**
 * \file src/event/event_init_for_token_less_than_equal.c
 *
 * \brief Initialize an event instance for the less than equal token event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_TOKEN_LESS_THAN_EQUAL, cursor);
}
