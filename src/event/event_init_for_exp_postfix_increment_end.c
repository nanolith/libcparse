/**
 * \file src/event/event_init_for_exp_postfix_increment_end.c
 *
 * \brief Initialize an event instance for a postfix increment end event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_EXP_POSTFIX_INCREMENT_END, cursor);
}
