/**
 * \file src/event/event_integer_token_init_for_unsigned_int.c
 *
 * \brief Initialize an unsigned int \ref event_integer_token instance.
 *
    ...
    unsigned int val)
{
    return
        event_integer_init_for_unsigned_internal(
            ev, CPARSE_INTEGER_TYPE_UNSIGNED_INT, cursor, val);
}
