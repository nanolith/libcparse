/**
 * \file src/event/event_init_for_token_keyword_continue.c
 *
 * \brief Initialize an event instance for the continue keyword token event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_TOKEN_KEYWORD_CONTINUE, cursor);
}
