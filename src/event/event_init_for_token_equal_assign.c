/**
 * \file src/event/event_init_for_token_equal_assign.c
 *
 * \brief Initialize an event instance for the equal assign token event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_TOKEN_EQUAL_ASSIGN, cursor);
}
