/**
 * \file src/event/event_init_for_comment_line_begin.c
 *
 * \brief Initialize an event instance for the comment line begin event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_COMMENT_LINE_BEGIN, cursor);
}
