/**
 * \file src/event/event_init_for_token_left_shift_equal.c
 *
 * \brief Initialize an event instance for the left shift equal token event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_TOKEN_LEFT_SHIFT_EQUAL, cursor);
}
