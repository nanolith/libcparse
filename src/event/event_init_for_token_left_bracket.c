/**
 * \file src/event/event_init_for_token_left_bracket.c
 *
 * \brief Initialize an event instance for the left bracket token event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_TOKEN_LEFT_BRACKET, cursor);
}
