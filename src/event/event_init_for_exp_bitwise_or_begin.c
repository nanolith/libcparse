/**
 * \file src/event/event_init_for_exp_bitwise_or_begin.c
 *
 * \brief Initialize an event instance for a bitwise or begin event.
 *
...
{
    return event_init(ev, CPARSE_EVENT_TYPE_EXP_BITWISE_OR_BEGIN, cursor);
}
