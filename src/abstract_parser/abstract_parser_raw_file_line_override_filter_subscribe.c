/**
 * \file
 * src/abstract_parser/abstract_parser_raw_file_line_override_filter_subscribe.c
 *
 * \brief Send a subscription request to the \ref raw_file_line_override_filter.
 *
