/**
 * \file src/abstract_parser/abstract_parser_preprocessor_scanner_subscribe.c
 *
 * \brief Send a subscription request to the \ref preprocessor_scanner.
 *
    ...
    CPARSE_SYM(abstract_parser)* ap, CPARSE_SYM(event_handler)* eh)
{
    ...
    retval = message_subscribe_init_for_preprocessor_scanner(&msg, eh);
